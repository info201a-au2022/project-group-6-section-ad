...
intro_panel <- tabPanel(
  ...
  p("The Olympics are the ultimate measure of a nation's best athletes. Lifetimes of training and dedication are spent by 
  ...
  img(src="OlympicMedalIntro.png", align = "right")
)
